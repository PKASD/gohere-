...
<body>
	...
	<ul id="nav2" class="nav justify-content-center bg-light">
		<li class="nav-item logo">
			<button type="button">
				<img src="Image/All.png" class="img-fluid" /><a class="nav-link active" href="#">전국</a>
			</button>
		</li>
		<li class="nav-item logo">
			<button type="button">
				<img src="Image/seoul.png" class="img-fluid" /><a class="nav-link active" href="#">서울/경기</a>
			</button>
		</li>

		<li class="nav-item logo">
			<button type="button">
				<img src="Image/gw.png" class="img-fluid" /><a class="nav-link active" href="#">강원</a>
			</button>
		</li>
		<li class="nav-item logo">
			<button type="button">
				<img src="Image/gs.png" class="img-fluid" /><a class="nav-link active" href="#">경남</a>
			</button>
		</li>

		<li class="nav-item logo">
			<button type="button">
				<img src="Image/ch.png" class="img-fluid" /><a class="nav-link active" href="#">충남</a>
			</button>
		</li>

		<li class="nav-item logo">
			<button type="button">
				<img src="Image/jr.png" class="img-fluid" /><a class="nav-link active" href="#">전남</a>
			</button>
		</li>

		<li class="nav-item logo">
			<button type="button">
				<img src="Image/jj.png" class="img-fluid" /><a class="nav-link active" href="#">제주</a>
			</button>
		</li>
	</ul>
	...
	<ul id="nav2" class="nav justify-content-center bg-light">
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false"> 사용자
				선택 </a>
			<div class="dropdown-menu">
				<a class="dropdown-item" href="#">좋아요 순</a> <a class="dropdown-item" href="#">조회수 순</a>
			</div></li>
	</ul>
	...
	<div class="space">
		<div class="card-columns text-center">
			<div class="card">
				<a href="tripgroup/everland.html"> <img src="Image/everland.jpg" class="card-img-top btn" alt="...">
				</a>
				<div class="card-body">
