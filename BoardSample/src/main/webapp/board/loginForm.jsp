...
<body>
	...
	<section>
		<form action="Index.html" method="post" id="login_Form">
			<h2>로그인</h2>
			<input type="text" placeholder="아이디를 입력하세요." name="uname" required><br> <input type="password" placeholder="비밀번호를 입력하세요." name="psw"
				required
			><br> <label for="agree" class="chk_box"> <input type="checkbox" id="agree" /> <span class="on"></span> 아이디 저장 <a
